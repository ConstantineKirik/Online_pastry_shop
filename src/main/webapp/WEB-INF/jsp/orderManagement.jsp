...
<a href="<c:url value="/showNewOrders"/> ">Показать новые заказы</a>
...
<c:forEach items="${newOrders}" var="order">
    ...
    <a href="<c:url value="/showFormedOrders"/> ">Показать сформированные заказы</a>
    ...
    <a href="<c:url value="/showDeliveredOrders"/> ">Показать доставленные заказы</a>
...
<sec:authorize access="hasRole('CONFECTIONER')">
    ...
    <a href="<c:url value="/showAcceptOrders"/> ">Показать принятые заказы</a>
...
<sec:authorize access="hasRole('COURIER')">
    ...
    <a href="<c:url value="/showSentOrders"/> ">Показать отправленные заказы</a>
